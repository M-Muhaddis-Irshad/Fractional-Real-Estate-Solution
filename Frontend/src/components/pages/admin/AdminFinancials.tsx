    ...
    <div className="riseIn">
      ...
      <div className="grid2">
        <div className="card cardPad">
          ...
          {series.length >= 2 ? (
            <AreaTrend data={series} dataKey="invested" height={250} />
          ) : (
        ...
        <div className="card cardPad">
          ...
          {series.length >= 1 ? (
            <BarTrend data={series} dataKey="fees" color="var(--success)" height={250} />
          ) : (
            <div className="dChartEmpty">Not enough data yet.</div>
          )}
        </div>
      ...
      <div className="grid-2-1">
        ...
        <form className="card cardPad" onSubmit={requestPayout}>
          ...
          <div className="dFormStack">
            ...
            <button className="btn btnPrimary" disabled={available <= 0}>
              Request payout
            </button>
          </div>
        </form>
            ...
            <tbody>
              {[...series].reverse().map((m) => (
                <tr key={m.month}>
                  ...
                  <td className="dMuted">
                    {m.invested ? ((m.fees / m.invested) * 100).toFixed(2) : "0.00"}%
                  </td>
                </tr>
              ))}
              {series.length === 0 && (
