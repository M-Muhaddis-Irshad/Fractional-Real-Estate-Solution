...
import type { Property, SiteContent, User } from "@/lib/types";
  ...
  features: [
    {
      ...
      text: "Every asset is underwritten and verified by our expert real-estate team before it ever reaches the marketplace.",
    },
    {
      title: "Automatic distributions",
      text: "Rental income is collected and distributed to shareholders automatically, no paperwork required.",
    },
    {
      title: "Blockchain-secured",
      text: "Ownership is recorded immutably on-chain with transparent, verifiable share records.",
    },
    {
      title: "Full liquidity options",
      text: "Trade fractional shares on the secondary market whenever you want to exit a position.",
    },
    {
      title: "Regulation-compliant",
      text: "Securities issued under Reg D/S exemptions with investor accreditation built in.",
    },
    {
      title: "Transparent reporting",
      text: "Track distributions, fees and asset performance in a single consolidated dashboard.",
    },
  ],
  testimonials: [
    {
      quote:
        "The clearest path to owning real estate without the barriers. My first distribution arrived on schedule, exactly as promised.",
      name: "Alex Vance",
      role: "PRO Investor",
    },
    {
      quote:
        "Finally a platform that treats fractional investing like a serious asset class. The analytics are world-class.",
      name: "Sara Ahmed",
      role: "PRO Investor",
    },
    {
      quote: "I diversified across three cities with a fraction of the capital a single unit would demand.",
      name: "Omar Farooq",
      role: "Investor",
    },
  ],
  faqs: [
    {
      ...
      a: "Each property is divided into a fixed number of shares. You buy shares at a set price, become a shareholder, and earn a proportional share of rental income.",
    },
    {
      q: "When do I receive distributions?",
      a: "Net rental income is distributed to shareholders automatically at the end of each month, after management fees.",
    },
    {
      q: "Can I sell my shares?",
      a: "Yes. Active shares can be traded on the secondary market, subject to liquidity and platform rules.",
    },
    {
      q: "Is my investment protected?",
      a: "Every property is legally ring-fenced and insured, and ownership records are immutable and verifiable.",
    },
  ],
  blog: [],
  cta: {
    ...
    subtitle:
      "Join thousands of investors already earning from the world's most resilient asset class.",
    button: "Get Started",
  },
};
...
export default function Landing() {
  ...
  const c: SiteContent = { ...DEFAULT_CONTENT, ...(content || {}) };
