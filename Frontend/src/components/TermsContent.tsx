/**
 * Shared Terms & Conditions content — single source of truth consumed by both
 * the registration-form modal (TermsModal) and the standalone /terms page.
 *
  ...
  return (
    <div className="termsBody">
      <section>
        ...
        <p>
          By creating an account and using the Flux platform (&ldquo;the Service&rdquo;), you agree to
      ...
      <section>
        ...
        <p>
          ...
          purchases, funding and distributions are <strong>simulated</strong> &mdash; no real money
