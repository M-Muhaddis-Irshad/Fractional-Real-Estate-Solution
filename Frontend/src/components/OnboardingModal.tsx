...
export default function OnboardingModal() {
  ...
  const finish = useCallback(() => {
    ...
    setTimeout(() => router.push("/discover"), 220);
  }, [close, router]);
    ...
    >
      ...
      >
        ...
        <div className="onbViewport">
          <div className="onbTrack" style={{ transform: `translateX(-${index * 100}%)` }}>
            {SLIDES.map((s, i) => (
              <section key={s.key} className="onbSlide" aria-hidden={i !== index}>
