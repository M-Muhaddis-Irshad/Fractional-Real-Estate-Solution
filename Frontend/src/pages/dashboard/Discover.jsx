...
const SORTS = {
  ...
  mostFunded: { label: "Most funded", fn: (a, b) => b.soldShares / b.totalShares - a.soldShares / a.totalShares },
...
export default function Discover() {
  ...
  const types = useMemo(() => ["All Assets", ...new Set(properties.map((p) => p.type))], [properties]);
  ...
  return (
    <div className="riseIn">
      <div className="pageHead">
        ...
        <select className="select dSortSelect" value={sortKey} onChange={(e) => setSortKey(e.target.value)}>
