      ...
      <div className="osSplit">
        ...
        <div className="osText">
          ...
          <Reveal className="osDocLinks">
            <a href="#terms" className="btn btnGhost btnSm">Terms &amp; Conditions</a>
            <a href="#terms" className="btn btnGhost btnSm">Privacy Policy</a>
          </Reveal>
        </div>
      </div>
    </section>
    ...
    <section className="osSection" id="support">
      <div className="osSplit osSplitReverse">
        <div className="osText">
          ...
          <Reveal>
            <a href="/#faq" className="osFaqLink">Browse our FAQs →</a>
          </Reveal>
        </div>
        <Reveal className="osMedia">
    ...
    <section className="osCta" id="cta">
      <Reveal className="osCtaInner">
        ...
        <p className="osCtaSub">
          Join thousands of investors building wealth in the world's most resilient asset class — or list your property and let the market fund it.
        </p>
        <div className="osCtaActions">
          <a href="/#properties" className="btn btnPrimary btnLg">Invest now →</a>
          <a href="/#properties" className="btn btnGhost btnLg osCtaGhost">List your property</a>
        </div>
      </Reveal>
    </section>
  );
