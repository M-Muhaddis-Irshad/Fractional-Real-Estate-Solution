export const DEFAULT_CONTENT = {
  ...
  blog: [
    { title: "Why fractional real estate is the next frontier", excerpt: "Institutional capital has known it for decades — diversification into real estate is non-negotiable. Now it's your turn.", date: "Jul 18, 2026", tag: "Insights" },
    { title: "A field guide to reading yield numbers", excerpt: "Gross yield, net yield, IRR — here's how to read the metrics that actually matter.", date: "Jul 02, 2026", tag: "Education" },
    { title: "Inside our underwriting process", excerpt: "What happens between a property being sourced and it appearing on the marketplace.", date: "Jun 21, 2026", tag: "Inside Flux" },
  ],
  cta: {
